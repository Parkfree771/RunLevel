...
import { CustomRouteIcon } from '@/components/ui/CustomRouteIcon';
import Link from 'next/link';
import { usePathname, useRouter } from 'next/navigation';
import { useSearchParams } from '@/app/SearchParamsProvider'; // Import from provider
  ...
  ko: {
    male: {
      ...
      'Half Marathon': {
        ...
        'D+': '두려움을 용기로 바꾼 도전. 21.1km의 거리가 발아래 놓이기 시작했다.',
    ...
    female: {
        '10km': {
            ...
            'C': '10km 완주를 통해 무엇이든 할 수 있다는 자신감을 얻은, 멋진 도전.자.',
          ...
          'Half Marathon': {
            ...
            'D+': '3시간 이내 완주를 목표로, 자신과의 싸움을 이겨내는 강인한 도전.자.',
         ...
         'Full Marathon': {
            ...
            'D': '메달의 무게보다 더 값진 감동의 드라마를 쓴, 이 시대의 가장 아름다운 도전.자.'
          }
    }
  },
  en: {
...
export default function HomeContent() {
    ...
    }, [pathname, searchParams, language, router]);
  ...
  return (
    <div ref={mainContainerRef} className="bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800 min-h-screen transition-colors">
      <header className="bg-white dark:bg-gray-900 shadow-sm border-b border-gray-200 dark:border-gray-700">
        <div className="max-w-4xl mx-auto px-3 sm:px-4 py-4 sm:py-6">
          <div className="relative flex items-center justify-center">
            <Link href="/" className="text-center cursor-pointer">
                <div className="flex items-center justify-center mb-1 sm:mb-2">
                    <Image src={logoSvg} alt="RunLevel Logo" className="mr-2 sm:mr-3 h-8 w-8 sm:h-10 sm:w-10" />
            ...
            <div className="absolute right-0 flex items-center gap-1 sm:gap-2">
              ...
              <Link href="/custom-training">
                <Button variant="outline" size="sm" className="border-gray-300 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-800 px-2 sm:px-3">
                  <CustomRouteIcon className="h-3 w-3 sm:h-4 sm:w-4" />
                </Button>
              </Link>
            </div>
          </div>
...
<Card className="rounded-2xl shadow-lg p-4 sm:p-6 md:p-8 bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700 animate-grade-reveal">
            ...
            >
                {language === 'ko' ? '나를 위한 다음 단계 훈련 계획 보기' : 'View My Next Level Training Plan'}
            </Button>
          </div>
        ...
        <div className="max-w-4xl mx-auto px-3 sm:px-4 py-6 sm:py-8">
          <div className="text-center mb-4">
            ...
            <div className="mt-2">
              ...
              <Link href="/privacy-policy" className="text-xs text-gray-500 dark:text-gray-500 hover:underline">
                개인정보처리방침
              </Link>
            </div>
          </div>
