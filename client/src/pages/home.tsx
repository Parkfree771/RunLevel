  ...
  male: {
    '10km': {
      ...
      standards: {
        ...
        'C': 68 * 60,              // 1:05:01 ~ 1시간 8분
        'D+': 72 * 60,             // 1:08:01 ~ 1시간 12분
        'D': Infinity              // 1시간 12분 초과
      }
    },
    '하프마라톤': {
      name: '하프마라톤 (21.1km)',
      ...
      standards: {
        ...
        'C': 148 * 60,             // 2:20:01 ~ 2시간 28분
        'D+': 155 * 60,            // 2:28:01 ~ 2시간 35분
        'D': Infinity              // 2시간 35분 초과
      }
    },
    '풀마라톤': {
      name: '풀마라톤 (42.2km)',
  ...
  female: {
    '10km': {
      ...
      standards: {
        ...
        'C': 82 * 60,              // 1:18:01 ~ 1시간 22분
        'D+': 87 * 60,             // 1:22:01 ~ 1시간 27분
        'D': Infinity              // 1시간 27분 초과
      }
    },
    '하프마라톤': {
      name: '하프마라톤 (21.1km)',
      ...
      standards: {
        ...
        'C': 168 * 60,             // 2:40:01 ~ 2시간 48분
        'D+': 175 * 60,            // 2:48:01 ~ 2시간 55분
        'D': Infinity              // 2시간 55분 초과
      }
    },
    '풀마라톤': {
      name: '풀마라톤 (42.2km)',
