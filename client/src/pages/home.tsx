  ...
  female: {
    '10km': {
      ...
      standards: {
        ...
        'S': 52 * 60 + 1,          // 47:01 ~ 52분
        'A+': 57 * 60 + 1,         // 52:01 ~ 57분
        'A': 60 * 60 + 1,          // 57:01 ~ 1시간 (서브-1시간)
        'B+': 67 * 60 + 1,         // 1:00:01 ~ 1시간 7분
        'B': 72 * 60 + 1,          // 1:07:01 ~ 1시간 12분
        'C+': 78 * 60 + 1,         // 1:12:01 ~ 1시간 18분
        'C': 85 * 60 + 1,          // 1:18:01 ~ 1시간 25분
        'D+': 90 * 60 + 1,         // 1:25:01 ~ 1시간 30분
    ...
    '하프마라톤': {
      ...
      standards: {
        'SS': 105 * 60,            // ~ 1시간 45분
        'S': 115 * 60 + 1,         // 1:45:01 ~ 1시간 55분
        'A+': 125 * 60 + 1,        // 1:55:01 ~ 2시간 5분 (서브-2)
        'A': 135 * 60 + 1,         // 2:05:01 ~ 2시간 15분
        'B+': 142 * 60 + 1,        // 2:15:01 ~ 2시간 22분
        'B': 150 * 60 + 1,         // 2:22:01 ~ 2시간 30분 (서브-230)
        'C+': 160 * 60 + 1,        // 2:30:01 ~ 2시간 40분
        'C': 170 * 60 + 1,         // 2:40:01 ~ 2시간 50분
        'D+': 180 * 60 + 1,        // 2:50:01 ~ 3시간
        'D': Infinity              // 3시간 초과
      }
    },
    '풀마라톤': {
      ...
      standards: {
        ...
        'S': 3 * 3600 + 50 * 60 + 1,  // 3:30:01 ~ 3시간 50분
        'A+': 4 * 3600 + 1,       // 3:50:01 ~ 4시간 (서브-4)
        'A': 4 * 3600 + 20 * 60 + 1,  // 4:00:01 ~ 4시간 20분
        'B+': 4 * 3600 + 42 * 60 + 1, // 4:20:01 ~ 4시간 42분
        'B': 5 * 3600 + 1,        // 4:42:01 ~ 5시간
        'C+': 5 * 3600 + 30 * 60 + 1, // 5:00:01 ~ 5시간 30분 (서브-5)
        'C': 6 * 3600 + 1,        // 5:30:01 ~ 6시간
        'D+': 6 * 3600 + 30 * 60 + 1, // 6:00:01 ~ 6시간 30분
